export default async function ({ addon, msg, global, console }) {
  ...
  function createDropdownItem(label = "", font = null, onClick = null, closeMenu = true) {
    ...
    if (typeof onClick === "string") {
      itemRoot.addEventListener("click", () => {
        setFont(font);
      });
  ...
  function closeFontDropdown() {
    const dropdownBtn = document.querySelector("[class*='font-dropdown_font-dropdown'][class*='dropdown_dropdown_']");
    if (!dropdownBtn) {
